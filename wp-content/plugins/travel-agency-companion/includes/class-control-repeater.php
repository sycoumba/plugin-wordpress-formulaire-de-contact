...
if( ! class_exists( 'Rara_Control_Repeater' ) ) {
    /**
     * Repeater control
     */
    class Rara_Control_Repeater extends WP_Customize_Control {
    	...
    	protected function l10n( $id = false ) {
    		$translation_strings = array(
    			'row'               => esc_attr__( 'row', 'travel-agency-companion' ),
    			'add-new'           => esc_attr__( 'Add new', 'travel-agency-companion' ),
    			'select-page'       => esc_attr__( 'Select a Page', 'travel-agency-companion' ),
    			'limit-rows'        => esc_attr__( 'Limit: %s rows', 'travel-agency-companion' ),
    			'hex-value'         => esc_attr__( 'Hex Value', 'travel-agency-companion' ),
    			'no-image-selected' => esc_attr__( 'No Image Selected', 'travel-agency-companion' ),
    			'remove'            => esc_attr__( 'Remove', 'travel-agency-companion' ),
    			'add-image'         => esc_attr__( 'Add Image', 'travel-agency-companion' ),
    			'change-image'      => esc_attr__( 'Change Image', 'travel-agency-companion' ),
    			'no-file-selected'  => esc_attr__( 'No File Selected', 'travel-agency-companion' ),
    			'add-file'          => esc_attr__( 'Add File', 'travel-agency-companion' ),
    			'change-file'       => esc_attr__( 'Change File', 'travel-agency-companion' ),
    		);
