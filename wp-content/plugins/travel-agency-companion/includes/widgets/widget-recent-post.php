...
class Travel_Agency_Recent_Post extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if( $qry->have_posts() ){
                            ...
                            <?php if( $show_date ) { ?>
                                <div class="entry-meta">
                                    <span class="posted-on"><a <?php echo $target; ?> href="<?php the_permalink(); ?>">
                                        <time datetime="<?php printf( __( '%1$s', 'travel-agency-companion' ), get_the_date('Y-m-d') ); ?>"><?php printf( __( '%1$s', 'travel-agency-companion' ), get_the_date() ); ?></time></a>
                                    </span>
                                </div>
                            <?php } ?>
                        </div>                        
            ...
            <?php
            $html = ob_get_clean();
            echo apply_filters( 'ta_companion_recent_post_widget_filter', $html, $args, $instance );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <?php esc_html_e( 'Open in New Tab', 'travel-agency-companion' ); ?> </label>
        </p>
        <?php 
    }
