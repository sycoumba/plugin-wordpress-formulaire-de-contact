...
function travel_agency_companion_register_popular_post_widget() {
    register_widget( 'Travel_Agency_Popular_Post' );
}
add_action( 'widgets_init', 'travel_agency_companion_register_popular_post_widget' );
...
class Travel_Agency_Popular_Post extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ?  $instance['title'] : __( 'Popular Posts', 'travel-agency-companion' );
        ...
        if( $qry->have_posts() ){
            ...
            <?php
            $html = ob_get_clean();
            echo apply_filters( 'ta_companion_popular_post_widget_filter', $html, $args, $instance );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>">
                ...
                <?php esc_html_e( 'Show posts in New Tab', 'travel-agency-companion' ); ?> 
            </label>
        </p>
        <?php
        echo 
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? sanitize_text_field( $new_instance['title'] ) : __( 'Popular Posts', 'travel-agency-companion' );
